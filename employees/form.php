...
<form action='' method='POST'> 
    <div class="control-group"> 
        ...
        <div class="controls">                
            <input class="input-xlarge" type="text" name='e_name' value='<?php  ?>' />
    ...
    <div class="control-group">    
        ...
        <div class="controls">
            <input class="input-xlarge" type="email" name='e_mail' value='<?php  ?>' /> 
        </div> 
    </div>
    <div class="control-group">    
    ...
    <div class="control-group">     
        ...
        <div class="controls">            
<!--            <input class="input-xlarge" type="text" name='e_role' value='<?php  ?>' /> -->
    ...
    <div class="control-group">    
        ...
        <div class="controls">        
            <input class="input-xlarge" type="text" name='e_payroll_no' value='<?php  ?>' /> 
        </div>
    </div>
    <div class="control-group">    
